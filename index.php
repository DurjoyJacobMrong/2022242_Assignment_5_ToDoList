  ...
  <div class="row">
    ...
    <h2 class="display-4 text-white text-center" >To-Do List</h2>
      <form class="mt-4" action="index_valid.php" method="post">
        ...
        <div class="">
          <input class="btn btn-success btn-block" type="submit" name="addtask" value="I got this!">
...
?>
  <tr>
  <td colspan="20" class="text-center display-4" ><img src="https://media.giphy.com/media/3y0oCOkdKKRi0/giphy.gif" alt="">
                    <h2 class="text-white">Think Fast....</h2></td>
  </tr>
<?php
}
?>
